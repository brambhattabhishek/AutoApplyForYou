...
current_city = "Lucknow"                  # Los Angeles, San Francisco, etc.
'''
...
street = "IT City"
state = "Uttar Pradesh"            # California, New York, etc.
zipcode = "226002"                # 12345, 67890, etc. (5 digit zip code)
country = "India"                  # United States, Canada, India, etc.
